    ...
    <DefaultLayout>
...

      {
        ...
        <Form layout="vertical" initialValues={editItem} onFinish={handleSubmit}>
            ...
            <Select>
              <Select.Option value="Mens Wear">Mens Wear</Select.Option>
              <Select.Option value="Womens Wear">Womens Wear</Select.Option>
              <Select.Option value="Kids Wear">Kids Wear</Select.Option>
